...
const skillCategories = {
	web: {
		...
		tools: ["Visual Studio Code", "Git", "GitHub", "Postman", "Google Cloud", "Canva"],
	},
	api: {
		title: "Backend & API",
		icon: WebhookIcon,
		...
		tools: ["Postman", "Git", "GitHub", "Google Cloud", "MongoDB Atlas", "MySQL Workbench"],
	},
	design: {
		title: "Design Tools",
		icon: ActivityIcon,
		description: "Product design and CAD software expertise",
		languages: [
			"AutoCAD",
			"SolidWorks",
			"CATIA V5",
